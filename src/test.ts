...
const currentBlockData = [{amount:10,sender:"97yyuigbi", recipient:"878hbujv78"},{amount:100,sender:"87ygvuigbi", recipient:"878hbug78"},{amount:30,sender:"87yyuigbi", recipient:"878hbug78"}];
const nonce = 100;
